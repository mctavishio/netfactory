...
const mills = require("./indexNetFiles.js").reverse();
const dt = new Date();
const timestamp = dt.getTime();
const datetime = dt.toDateString();
const description = "code art ::: algorithmic netfactory patterns";
...
<head>
	...
	body {
		background-image: url("${gsurl}/${mills[4]}/poster0000_${mills[4].substring(4)}.png"); 
...
<nav>
	<ul>
		...
		<li><a href="#list">netfactory sequences</a></li>
...
indexhtml = indexhtml + mills.map( name=>name.slice(4) ).map( name=>{
	return	`
		<li><a href="index${name}.html">netfactory sequence ${name}</a></li>`;
}).join("");
indexhtml = indexhtml + ` 
	</ul>
	</div>
...
<nav>
	<ul>
		<li><a href="index.html" id="indexlink">back to netfactory index</a></li>
		<li><a href="https://mctavish.work/index.html" id="homelink">go to mctavish portfolio</a></li>
